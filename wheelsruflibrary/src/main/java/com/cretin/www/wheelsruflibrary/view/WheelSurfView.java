...
import com.cretin.www.wheelsruflibrary.DP2SPUtil;
...
public class WheelSurfView extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if ( mGoImgRes == 0 ) {
            mStart.setImageResource(R.mipmap.zhizhen);
        } else {
...
//
                    ...
                    layoutParams.width = DP2SPUtil.dip2px(mContext,100);
                    layoutParams.height = DP2SPUtil.dip2px(mContext,100);
