...
public class StaggeredGridView extends ViewGroup {
    ...
    public StaggeredGridView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs,StaggeredGridView);
            mColCount = a.getInteger(1, 2);
            mDrawSelectorOnTop = a.getBoolean(0, false);
        } else {
            mColCount = 2;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (index < 0) {
                    LogYiFu.e(TAG, "onInterceptTouchEvent could not find pointer with id " +
