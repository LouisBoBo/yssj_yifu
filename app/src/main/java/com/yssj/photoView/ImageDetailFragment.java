...
import com.yssj.huanxin.widget.photoview.PhotoViewAttacher;
...
//		SetImageLoader.initImageLoader(null, mImageView, mImageUrl,"");
		PicassoUtils.initImage(getActivity(), mImageUrl, mImageView);
