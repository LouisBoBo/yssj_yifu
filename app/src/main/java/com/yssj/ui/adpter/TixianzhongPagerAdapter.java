...
public class TixianzhongPagerAdapter extends BaseMainAdapter {
    private int indext;
    private boolean isDongjie;

    public TixianzhongPagerAdapter(Context context, int indext, boolean isDongjie) {
        super(context);
        this.indext = indext;
...
//        }
        ...
        String money = new DecimalFormat("0.0#").format(Double.parseDouble(mapObj.get("money").toString()));
