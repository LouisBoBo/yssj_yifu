...
import com.yssj.ui.fragment.DuoItemFragment;
import com.yssj.ui.fragment.DuoShuaiDanFragment;
import com.yssj.ui.fragment.WqjxDuoBao;
import com.yssj.ui.fragment.WqjxShaiDan;
 ...
 * 夺宝记录
 */
public class SnatchActivity extends BasicActivity
    ...
    private void initView() {
        ...
        fragments.add(new DuoItemFragment()); // 夺宝记录 我的参与记录
        fragments.add(new DuoShuaiDanFragment()); // 夺宝记录 我的晒单记录
        ...
        switch (index) {
            case 0:
                ...
                fragmentss.add(new DuoItemFragment()); // 夺宝记录 我的参与
                fragmentss.add(new DuoShuaiDanFragment()); // 夺宝记录 我的晒单记录
            ...
            case 1:
                ...
                wqjx_fragment.add(new WqjxDuoBao()); // 往期揭晓 往期揭晓(左边)
                wqjx_fragment.add(new WqjxShaiDan()); // 往期揭晓 晒单分享(右边)
...
//			System.out.println("******left****=" + choice);
                ...
                mViewPager.removeAllViews();
                List<Fragment> fragments = new ArrayList<Fragment>();
                fragments.add(new DuoItemFragment()); // 夺宝记录 我的参与
                fragments.add(new DuoShuaiDanFragment()); // 夺宝记录 我的晒单分享
                mAdapter = new PagerAdapter(getSupportFragmentManager(), fragments);
                mViewPager.setAdapter(mAdapter);
    ...
    public void onRefreshlintener() {
        ...
        if (choice.equals("0")) {
            if (my_choice.equals("0")) {
                ...
                DuoItemFragment fragment = (DuoItemFragment) mAdapter.getItem(0);
                fragment.refresh();
            }
        ...
        if (choice.equals("1")) {
            if (my_choice.equals("0")) {
                ...
                WqjxDuoBao fragment = (WqjxDuoBao) wqjx_adapter.getItem(0);
                fragment.refresh();
            }
            ...
            if (my_choice.equals("1")) {
                ...
                WqjxShaiDan fragment = (WqjxShaiDan) wqjx_adapter.getItem(1);
                fragment.refresh();
            }
        }
