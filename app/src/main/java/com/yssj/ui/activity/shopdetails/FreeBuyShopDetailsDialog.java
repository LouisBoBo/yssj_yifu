 ...
 *
 */
public class FreeBuyShopDetailsDialog extends Dialog implements OnClickListener, OnItemClickListener {
...
//	private ImageLoadingListener animateFirstListener;
    ...
    public FreeBuyShopDetailsDialog.OnCallBackShopCartNewMeal callBackShopCartNewMeal;




    public FreeBuyShopDetailsDialog(Context context, int style, int width, int height, Shop shop
