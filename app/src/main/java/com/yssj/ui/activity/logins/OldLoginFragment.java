 ...
 * 
 */
public class OldLoginFragment extends Fragment implements OnClickListener {
	...
	public static OldUserLoginActivity instance;

	private String deviceToken;

	// private boolean isOldLogin;//老用户登录
	public static OldLoginFragment newInstance(String title) {
		OldLoginFragment fragment = new OldLoginFragment();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		instance = (OldUserLoginActivity) getActivity();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		if (OldUserLoginActivity.isQudao) {
			if (!OldUserLoginActivity.isOldLogin) {
				v = inflater.inflate(R.layout.activity_login_qudao, container, false);
			} else {
				v = inflater.inflate(R.layout.fragment_login, container, false);
				;// 老用户登录
				v.findViewById(R.id.tv_third_rl).setVisibility(View.INVISIBLE);
			}
	...
	private void initViews(View v) {
		...
		if (!LoginActivity.noUserRegist || OldUserLoginActivity.isOldLogin) {
		...
		} else if (!OldUserLoginActivity.isOldLogin) {
	...
	protected void openId(SHARE_MEDIA weixin, final Context context) {
