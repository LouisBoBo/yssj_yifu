...
public class BannerLayout extends FrameLayout {
    ...
    private int WHAT_CLICK_PLAY = 1001;
    ...
    protected Handler mHandler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(Message msg) {
            ...
            } else if (msg.what == WHAT_CLICK_PLAY) {
                if (currentIndex == mLayoutManager.getCurrentPosition()) {
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        autoPlayDuration = a.getInt(R.styleable.BannerLayout_interval, 1000);
        ...
        mLayoutManager.setOnPageChangeListener(new BannerLayoutManager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                onBannerScrollChangeListener.onScrollChange(position);
        ...
        mRecyclerView.scrollToPosition(50*3); //切换到中间位置
...
//
        ...
        mHandler.sendEmptyMessage(WHAT_CLICK_PLAY);
...
//
    ...
    public interface OnBannerScrollChangeListener {
        void onScrollChange(int currentPosition);
    }

    OnBannerScrollChangeListener onBannerScrollChangeListener;

    public void setBannerScrollChangeListener(OnBannerScrollChangeListener onBannerScrollChangeListener) {
        this.onBannerScrollChangeListener = onBannerScrollChangeListener;
    }
