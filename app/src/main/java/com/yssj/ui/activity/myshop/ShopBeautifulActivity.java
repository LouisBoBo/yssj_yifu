...
//
//		img_to_mine_like = (ImageView) findViewById(R.id.img_to_mine_like);
...
//				ShopBeautifulActivity.this), "android");
//	}
//
//	@Override
...
//		/**
//		 * switch (v.getId()) { case R.id.img_back: if(webview.canGoBack()) {
//		 * webview.goBack(); } else { super.onBackPressed(); } break;
//		 * 
//		 * default: break; } super.onClick(v);
//		 */
//		switch (v.getId()) {
