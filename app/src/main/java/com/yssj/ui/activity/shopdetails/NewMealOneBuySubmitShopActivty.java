...
public class NewMealOneBuySubmitShopActivty extends BasicActivity {
    ...
    public static NewMealOneBuySubmitShopActivty instance;
        ...
        new SAsyncTask<Void, Void, HashMap<String, String>>(this, R.string.wait) {// 获取地址
            ...
            protected void onPostExecute(FragmentActivity context, HashMap<String, String> result, Exception e) {
                ...
                if (requestCode == 1002) {// 设置地址
                    NewMealOneBuySubmitShopActivty.this.addResult = result;
                    // 设置地址
...
//            submit_total.setText("¥0.0");
//        } else {


        onePrice = new DecimalFormat("#0.0")
                .format(Double.parseDouble(onePrice));

        tv_settle_account.setText("实付款¥" + onePrice);
        submit_total.setText("¥" + onePrice);
...
//                tv_discout.setText("¥" + new DecimalFormat("#0.00").format(good.getShop_se_price()));
                ...
                v.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View arg0) {
                        ...
                        Intent intent = new Intent(NewMealOneBuySubmitShopActivty.this, ShopDetailsActivity.class);
...
//                return ComModel2.newMealSubmitShopOneYuan( sbResult,context, mapMsg, listGoods, 0, addressId,
//                        0, mMapTen, mMapFive, mMapTwo, mMapOne, 0);
            ...
            protected void onPostExecute(FragmentActivity context, HashMap<String, Object> result, Exception e) {
                ...
                if (null == e) {
                        ...
                        Intent OneBuyintent = new Intent(NewMealOneBuySubmitShopActivty.this, OneBuyGroupsDetailsActivity.class);
                        OneBuyintent.putExtra("order_code", orderNo);
                        OneBuyintent.putExtra("roll_code", result.get("roll_code") + "");
                        OneBuyintent.putExtra("isMeal", true);
                        startActivity(OneBuyintent);

                        NewMealOneBuySubmitShopActivty.this.finish();
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.btn_pay:
                YunYingTongJi.yunYingTongJi(NewMealOneBuySubmitShopActivty.this, 111);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (requestCode == 1001) { // 修改地址
            ...
            NewMealOneBuySubmitShopActivty.this.setResult(1); // 1，代表支付成功；
