...
//
//public class DailyAmountFragment extends Fragment implements
...
//		View v = inflater.inflate(R.layout.daily_amount_fragment, container,
//				false);
//		initView(v);
//		return v;
//	}
...
//				return ComModel2.getDailyAmount(context);
//			}
//
//			@Override
...
//					tv_today.setText(result.get(result.size() - 1).get("date")
//							.toString());
//					tv_amount.setText("¥"
...
//														result.size() - 2).get(
//														"sum"))));
//						tv_yesterday_sum.setText(result.get(result.size() - 2)
//								.get("count") + "单");
//						tv_yesterday.setText(result.get(result.size() - 2)
//								.get("date").toString());
//
//						
//					}
...
//		LineDataSet set1 = new LineDataSet(yVals1, "每日金额");
