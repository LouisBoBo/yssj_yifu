...
public class QingItemFragment extends Fragment {
	...
	public PullToRefreshListView getmList() {
		return mList;
	}

	public static QingItemFragment newInstances(int position, String title, String id, Context context) {
		QingItemFragment instance = new QingItemFragment();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		View v = inflater.inflate(R.layout.item_fragment_view_myshop_qing, container, false);

		title = getArguments().getString("title");
		id = getArguments().getString("id");
		index = 1;
		System.out.println("取出的id=" + id);
		mList = (PullToRefreshListView) v.findViewById(R.id.dataList);
	...
	private class DateAdapter extends BaseAdapter {
		...
		public View getView(int position, View view, ViewGroup arg2) {
			...
			if (view == null) {
				...
				items = new ItemViews();
				items.left = (ItemView) view.findViewById(R.id.left);
				items.left.setHeight(picHeight);
				items.right = (ItemView) view.findViewById(R.id.right);
			...
			if (dataList.size() > position) {
				...
				items.left.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View arg0) {
						...
						QingItemFragment.this.position = position;
