...
public class AppendEvaluateOrderFragment extends BaseFragment implements onDeteleImgLintener{
	...
	public AppendEvaluateOrderFragment() {
	}
	...
	public View initView() {
		...
		view = View.inflate(context, R.layout.append_evaluate_order_content, null);
		view.setBackgroundColor(Color.WHITE);
		view.findViewById(R.id.choose_pic).setOnClickListener(this);
		view.findViewById(R.id.choose_pic).setBackgroundColor(Color.WHITE);
