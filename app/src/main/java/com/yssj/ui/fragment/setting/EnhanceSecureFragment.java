...
public class EnhanceSecureFragment extends BaseFragment implements OnClickListener {
	...
	private String url = YUrl.YSS_URL_ANDROID_H5 + "view/other/howtoImportSafe.html";
