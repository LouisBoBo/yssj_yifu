...
public class HHDetailUncheckFragment extends BaseFragment {
	...
	public View initView() {
		view = View.inflate(context, R.layout.activity_payback_hh_detail_uncheck, null);
			...
			if(returnShop != null){
				...
				new CountDownTimer(returnShop.getLast_time().getTime()-System.currentTimeMillis(),1000) {
					...
					public void onFinish() {
						tv_end_time.setText("商家在指定时间内没有处理，系统已自动同意换货。");
					}
				}.start();
