...
public class ApplyPlatformFragment extends BaseFragment implements
		onDeteleImgLintener {
	...
	private LinearLayout container;// 显示拍照图片容器
	...
	public View initView() {
		...
		view = View.inflate(context, R.layout.apply_platform_fragment, null);
		view.findViewById(R.id.choose_pic).setOnClickListener(this);
		container = (LinearLayout) view.findViewById(R.id.apply_container);
		et_content = (EditText) view.findViewById(R.id.apply_et_content);
	...
	public void onClick(View v) {
		...
		case R.id.choose_pic: // 选择图片
			...
			doPickPhotoAction();
//			Intent intent=new Intent(getActivity(),ApplyPlatformActivity.class);
