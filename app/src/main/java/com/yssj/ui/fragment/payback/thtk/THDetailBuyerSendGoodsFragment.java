 ...
 *
 */
public class THDetailBuyerSendGoodsFragment extends BaseFragment {
	
	private TextView tvTitle_base;
	private LinearLayout img_back;
	private ImageView img_right_icon;
	
	private TextView tv_order_je,tv_order_code,tv_hh_date,tv_th_wl_num,tv_th_wl_name,tv_receive_name,tv_phone,tv_post_code,tv_address;
	...
	public View initView() {
		view = View.inflate(context, R.layout.activity_payback_th_detail_buyer_send_goods, null);
		...
		tv_th_wl_num = (TextView) view.findViewById(R.id.tv_th_wl_num);	// 退货物流单号
		tv_th_wl_name = (TextView) view.findViewById(R.id.tv_th_wl_name);	// 退货物流名称
	...
	public void initData() {
		...
		if(bundle != null){
			...
			if(returnShop != null){
				...
				tv_hh_date.setText("退货时间:" + DateFormatUtils.format(returnShop.getAdd_time(), "yyyy-MM-dd HH:mm:ss"));
				...
				tv_th_wl_name.setText("退货物流:  " + YJApplication.mapKuaidi.get(returnShop.getExpress_id().split(":")[1]));
				tv_th_wl_num.setText("物流单号:  " + returnShop.getExpress_id().split(":")[0]);
