 ...
 * 
 */
public class TKDetailAliFailedFragment extends BaseFragment {
	...
	public View initView() {
		view = View.inflate(context,
				R.layout.activity_payback_tk_detail_ali_failed, null);
	...
	public void initData() {
		...
		if (bundle != null) {
			...
			if (returnShop != null) {
				...
				if ( !"null".equals(returnShop.getEnd_time())) {
				...
				tv_tk_status.setText("支付宝审核退款失败");
