...
@SuppressLint("NewApi") public class HHMemberShopFragment extends BaseFragment {
	...
	public View initView() {
		...
		et_hh_reason = (EditText) view.findViewById(R.id.et_hh_reason);			// 换货原因
	...
	public void initData() {
		...
		listhh.add("材质/面料与商品不符");
		listhh.add("大小尺寸与商品不符");
		listhh.add("做工瑕疵(胶水印/两只鞋不对称等)");
		listhh.add("质量问题(断底/断面/脱胶等)");
