 ...
 *
 */
public class TKDetailSellerRefuseFragment extends BaseFragment {
	
	private TextView tvTitle_base;
	private LinearLayout img_back;
	private ImageView img_right_icon;
	
	private TextView tv_order_je,tv_order_code,tv_tk_date,tv_apply_date,tv_tk_reason;
	...
	public View initView() {
		view = View.inflate(context, R.layout.activity_payback_tk_detail_seller_refuse, null);
		...
		tv_apply_date = (TextView) view.findViewById(R.id.tv_apply_date);	// 申请退款时间
	...
	public void initData() {
		...
		if(bundle != null){
			...
			if(returnShop != null){
				...
				tv_tk_date.setText("申请退款时间:" + DateFormatUtils.format(returnShop.getAdd_time(), "yyyy-MM-dd HH:mm:ss"));
				tv_apply_date.setText(DateFormatUtils.format(returnShop.getAdd_time(), "yyyy-MM-dd HH:mm:ss"));
				tv_tk_reason.setText("退款原因:" + returnShop.getCause());
			}
		}
