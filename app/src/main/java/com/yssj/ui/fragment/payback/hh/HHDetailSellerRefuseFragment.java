 ...
 *
 */
public class HHDetailSellerRefuseFragment extends BaseFragment {
	...
	public View initView() {
		view = View.inflate(context, R.layout.activity_payback_hh_detail_seller_refuse, null);
		...
		tv_apply_date = (TextView) view.findViewById(R.id.tv_apply_date);	// 申请换货时间
	...
	public void initData() {
		...
		if(bundle != null){
			...
			if(returnShop != null){
				...
				tv_hh_reason.setText("换货原因:" + returnShop.getCause());
			}
		}
