 ...
 *
 */
public class TKDetailAuditPassFragment extends BaseFragment {
	
	private TextView tvTitle_base;
	private LinearLayout img_back;
	private ImageView img_right_icon;
	
	private TextView tv_order_je,tv_order_code,tv_apply_date,tv_end_time,tv_return_money,tv_tk_status,tv_tk_categroy,tv_tk_je,tv_tk_reason;
	...
	public View initView() {
		view = View.inflate(context, R.layout.activity_payback_tk_detail_platform_audit, null);
	...
	public void initData() {
		...
		if(bundle != null){
			...
			if(returnShop != null){
				...
				tv_apply_date.setText("完成时间:" + DateFormatUtils.format(returnShop.getEnd_time(), "yyyy-MM-dd HH:mm:ss"));
				
				tv_end_time.setText(DateFormatUtils.format(returnShop.getEnd_time(), "yyyy-MM-dd HH:mm:ss"));
				
				tv_return_money.setText("商家同意退款，交易款项" + new DecimalFormat("#0.00").format(returnShop.getMoney()) + "已归至您的账户");
