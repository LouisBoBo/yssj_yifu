 ...
 * 
 */
public class TKDetailCommit9Fragment extends BaseFragment {
	...
	private TextView tv_order_je, tv_order_code, tv_apply_date, tv_end_time,
			...
			tv_tk_reason,tv_consumer_status;
	...
	public View initView() {
		view = View.inflate(context,
				R.layout.activity_payback_tk_detail_commit_9, null);
		...
		tv_consumer_status = (TextView) view.findViewById(R.id.tv_consumer_status);
		return view;
	}
	...
	public void initData() {
		...
		if (bundle != null) {
			...
			if (returnShop != null) {
				...
				tv_tk_status.setText("正在"+category +"中");
				tvTitle_base.setText(category+"详情");
				tv_tk_categroy.setText(category);
				tv_consumer_status.setText("商家同意"+category);
