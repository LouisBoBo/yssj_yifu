...
public class FindPasswordFragment extends BaseFragment implements OnClickListener {
	...
	private String url = YUrl.YSS_URL_ANDROID_H5 + "view/other/howTofintPwd.html";
