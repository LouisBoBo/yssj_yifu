...
//体现额度冻结详情  --此处只有体现额度明细才能跳过来
public class TxianDongjiePage extends BasePager {
	private HashMap<String, Object> map;

	public TxianDongjiePage(Context context) {
		super(context);
	...
	public void initData() {
		...
		mAdapter = new MyIntergralPageAdapter(context, 1,true);
	...
	private void queryOutputIntergralConponsData() {
		...
		new SAsyncTask<Integer, Void, List<HashMap<String, Object>>>((FragmentActivity) context, R.string.wait) {
			...
			protected List<HashMap<String, Object>> doInBackground(FragmentActivity context, Integer... params)
					throws Exception {
				return ComModel2.getTixianedumingxiDongjie(context, currPage, "desc", "id");
