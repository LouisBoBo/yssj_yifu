...
//
//public class FinePostListPager extends BasePager {
...
//	
//	public FinePostListPager(Context context,HashMap<String, Object> map) {
//		super(context);
//		this.map = map;
//	}
//
...
//				
//				return YJApplication.instance.isLoginSucess()?ComModel2.getPostList(context, (String)map.get("circle_id"), currPage,"null",1,0)
//						:ComModel2.getPostList2(context, (String)map.get("circle_id"), currPage,"null",1,0);
//			}
//			
//			@Override
