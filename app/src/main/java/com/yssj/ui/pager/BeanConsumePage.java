...
public class BeanConsumePage extends BasePager {
	private HashMap<String, Object> map;

	public BeanConsumePage(Context context) {
		super(context);
	}
	...
	public void initData() {
		currPage = 1;
		queryPearsList();
		mAdapter = new MyPearsPageAdapter(context,0);
	...
	private void queryPearsList() {
		new SAsyncTask<Integer, Void, List<HashMap<String, Object>>>(
			...
			protected List<HashMap<String, Object>> doInBackground(FragmentActivity context,
				...
				return ComModel2.getPearsDetail(context, currPage,"desc","id",1);
			}
