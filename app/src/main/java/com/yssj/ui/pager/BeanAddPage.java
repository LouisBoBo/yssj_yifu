...
public class BeanAddPage extends BasePager {
	private HashMap<String, Object> map;

	public BeanAddPage(Context context) {
		super(context);
	}
	...
	public void initData() {
		currPage = 1;
		queryPearsData();
		mAdapter = new MyPearsPageAdapter(context,1);
	...
	private void queryPearsData() {
		...
		new SAsyncTask<Integer, Void, List<HashMap<String, Object>>>(
			...
			protected List<HashMap<String, Object>> doInBackground(FragmentActivity context,
				...
				return ComModel2.getPearsDetail(context, currPage,"desc","id",2);
