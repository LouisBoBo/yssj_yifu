...
//
//public class AllPostListPage extends BasePager {
//	private HashMap<String, Object> map;
//
//	public AllPostListPage(Context context,HashMap<String, Object> map) {
//		super(context);
//		this.map = map;
//	}
//
...
//		mAdapter = new AllPostListPagerAdapter(context,map.get("circle_id").toString());
...
//					return ComModel2.getPostList(context, (String)map.get("circle_id"), currPage,"true",0,0);
//				}else{
//				return ComModel2.getPostList2(context, (String)map.get("circle_id"), currPage,"true",0,0);
//				}
//			}
//			
//			@Override
