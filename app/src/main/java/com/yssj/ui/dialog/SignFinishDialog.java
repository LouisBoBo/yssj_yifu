...
// * 
// */
//public class SignFinishDialog extends Dialog implements OnClickListener {
...
//	private Boolean isDangtian;// 是否是点击当天已完成任务的弹窗
//
//	private Button bt_close;// 明天来按钮，--关闭 一个按钮
//
//	public SignFinishDialog(Context context, int now_type_id, int now_type_id_value, int next_type_id,
//			int next_type_id_value, Boolean duobao, String CanYunumber, Boolean isDangtian) {
//		super(context);
...
//		setContentView(R.layout.dialog_sign_finish);
//		getWindow().setBackgroundDrawableResource(android.R.color.transparent);
//
//		// now_type_id =
//		// Integer.valueOf(SharedPreferencesUtil.getStringData(context,
//		// "now_type_id", "0"));
//		// now_type_id_value =
//		// Integer.valueOf(SharedPreferencesUtil.getStringData(context,
//		// "now_type_id_value", "0"));
...
//			// } else { //包邮完成任务
//
//			// 夺宝完成任务的弹窗不再在此展示（点击当天已完成任务除外）
//
//			tv_canyuhao1.setVisibility(View.GONE);
//			tv_canyuhao2.setVisibility(View.GONE);
//
//			if (isDangtian) {// 点击当天已完成任务的弹窗
//				img_now.setImageResource(R.drawable.duobao_aoyou);
//
//				if (now_type_id_value == 3) {
//					tv_now.setText("3元包邮/夺宝");
//				} else if (now_type_id_value == 5) {
//					tv_now.setText("5元包邮/夺宝");
//				}
//
//			} else {
//
...
//		case R.id.close:
//			
//			Intent intent3 = new Intent((Activity) context, MainMenuActivity.class);
...
//		case R.id.bt_look:
//			// 查余额
//			if (now_type_id == 5 || now_type_id == 8 || now_type_id == 6) {
