...
public class SimpleCountDownTimer extends CountDownTimer {
    ...
    private boolean isYJ;//是否是佣金的倒计时
    private String yjMonery;
    /**
     * 结束监听
     */
    ...
    public SimpleCountDownTimer(long millisInFuture, TextView tvDisplay, boolean isYJ, String yjMonery) {
        super(millisInFuture, DEFAULT_INTERVAL);
        this.tvDisplay = tvDisplay;
        this.isYJ = isYJ;
        this.yjMonery = yjMonery;
    }
...
//        tvDisplay.setText(strLHr + ":" + strLMin + ":" + strLSec + ":" + strLMs);
        if (isYJ) {
            tvDisplay.setText(strLMin + ":" + strLSec + "后" + yjMonery);
    ...
    private String getMs(long time) {
        ...
        return time > 100 ? strMs.substring(0, strMs.length() - 2) : "0";
    }
