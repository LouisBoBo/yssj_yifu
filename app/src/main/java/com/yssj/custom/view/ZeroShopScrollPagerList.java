 ...
 *
 */
public class ZeroShopScrollPagerList extends LinearLayout {
	...
	public ZeroShopScrollPagerList(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	protected void onFinishInflate() {
		...
		mTop = findViewById(R.id.zero_shop_top_view);
		mNav = findViewById(R.id.zero_shop_title);
