 ...
 * 
 */
public class IndianaNormalTopClickView extends LinearLayout implements
	...
	public IndianaNormalTopClickView(Context context, int evacount) {
		super(context);
	...
	public IndianaNormalTopClickView(Context context, AttributeSet attrs) {
		super(context, attrs);

		LayoutInflater.from(context).inflate(R.layout.indiana_normal_top_view,
				this);
