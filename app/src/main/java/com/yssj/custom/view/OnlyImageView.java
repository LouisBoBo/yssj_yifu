...
// */
//
//public class OnlyImageView extends ImageView{
//
//	/**
//	 * 用于对图片进行移动和缩放变换的矩阵
//	 */
...
//				if ((currentStatus == Common.STATUS_OUT && totalRatio < 4 * initRatio)
...
////			 手指离开屏幕时将临时值还原
//			if(event.getPointerCount() ==1&&lastXMove==-1&&lastYMove==-1){
//				
////				getParent().getClass().
//				break;
//				
