...
//		sListener = (ScrollViewListener) context;
	}
	...
	protected void onScrollChanged(int x, int y, int oldx, int oldy) {
		...
		showStickyView();
		if (sListener != null) {  
			sListener.onScrollChanged(x, y, oldx, oldy);  
        }  
	}
	public ScrollViewListener sListener;
	...
	private void showStickyView() {
		...
		for (View v : mStickyViews) {
			...
			LogYiFu.e("offset", "getTop():"+v.getTop()+" getScrollY():"+getScrollY());
			if (topOffset <= 0) {
