 ...
 *
 */
public class ScrollPagerIntimateList extends LinearLayout {
	/**
...
//	private boolean isShopTitle = false;
	...
	public static int mTopViewHeight = 0;
	...
	public ScrollPagerIntimateList(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	protected void onSizeChanged(int w, int h, int oldw, int oldh) {
		...
		if (mTopViewHeight == 0) {
			//width / 4:横向滑动图片的高度
//			mTopViewHeight = mTop.getMeasuredHeight() + width / 4 + DP2SPUtil.dp2px(getContext(), 10);
			mTopViewHeight = mTop.getMeasuredHeight()+DP2SPUtil.dp2px(getContext(), 1);
		}
	}
...
//							HomePageFragment.tv_fenlei.getBackground().setAlpha(255 - i);
//							HomePageFragment.tv_zhuanqian.getBackground().setAlpha(255 - i);
