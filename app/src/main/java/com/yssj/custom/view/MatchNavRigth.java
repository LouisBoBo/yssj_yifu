 ...
 *
 */
public class MatchNavRigth extends LinearLayout {
	...
	public MatchNavRigth(Context context,String shop_code,int from,boolean isforcelook) {
		super(context);
		mContext = context;
		this.from = from;
	...
	public MatchNavRigth(Context context, AttributeSet attrs,String shop_code) {
		super(context, attrs);
		mContext = context;
		initView(context,shop_code);
	}

	public MatchNavRigth(Context context, AttributeSet attrs, int defStyle,String shop_code) {
	...
	private void initView(Context context,final String shop_code) {
		LayoutInflater.from(context).inflate(R.layout.match_nav_rigth, this, true);
