 ...
 *
 */
public class SnatchScrollPagerList extends LinearLayout {
	...
	public SnatchScrollPagerList(Context context, AttributeSet attrs) {
		super(context, attrs);
...
//		System.out.println("********mNav="+mNav);
		View view = findViewById(R.id.zero_shop_content_viewpager);
...
//		params.height = getMeasuredHeight() - /*mNav.getMeasuredHeight()*/
		...
		params.height = getMeasuredHeight() -DP2SPUtil.dp2px(getContext(), -10);

//		System.out.println("我是夺宝————getMeasuredHeight()="+getMeasuredHeight());
//		System.out.println("我是夺宝————mNav.getMeasuredHeight()="+mNav.getMeasuredHeight());
		if(refreshHeight==0){
