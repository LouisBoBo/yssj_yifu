 ...
 * 
 */
public class IndianaShopTopClickView extends LinearLayout implements
	...
	public IndianaShopTopClickView(Context context, int evacount) {
		super(context);
	...
	public IndianaShopTopClickView(Context context, AttributeSet attrs) {
		super(context, attrs);

		LayoutInflater.from(context).inflate(R.layout.indiana_shop_top_view,
				this);
