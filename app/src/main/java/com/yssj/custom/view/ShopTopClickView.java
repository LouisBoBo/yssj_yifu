 ...
 *
 */
public class ShopTopClickView extends LinearLayout implements OnCheckedChangeListener{
	...
	public ShopTopClickView(Context context,int evacount) {
		super(context);
	...
	public ShopTopClickView(Context context, AttributeSet attrs) {
		super(context, attrs);
		
		LayoutInflater.from(context).inflate(R.layout.shop_top_view, this);
