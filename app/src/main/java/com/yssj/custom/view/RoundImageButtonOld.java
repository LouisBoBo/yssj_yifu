 ...
 * @author y
 */
public class RoundImageButtonOld extends ImageButton {
    ...
    public RoundImageButtonOld(Context context) {
        super(context);
        mContext = context;
    }

    public RoundImageButtonOld(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        setCustomAttributes(attrs);
    }

    public RoundImageButtonOld(Context context, AttributeSet attrs, int defStyle) {
