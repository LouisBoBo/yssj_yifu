...
//		if(DEBUG)
//			LogYiFu.d(TAG, "onWindowFocusChanged");
//
...
//
//			if(DEBUG)
//				LogYiFu.d(TAG, String.format("String Fling: [%d, %d] to [%d]", initialY, initialVelocity, mScroller.getFinalY()));
//
...
//		if(DEBUG)
//			LogYiFu.v(TAG, "tryOffsetChilderenTopAndBottom: " + offset);
//		final int count = getChildCount();
//
//		for (int i = 0; i < count; i++) {
...
//	//				result = false;
//	//				LogYiFu.d("ViewDebug", "AbsListView " + this +
