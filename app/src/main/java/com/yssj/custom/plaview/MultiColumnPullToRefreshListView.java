...
//		((AnimationDrawable)imgHeader.getBackground()).stop();
...
//		
//		llText = (LinearLayout) header.findViewById(R.id.ptr_id_textwrapper);
//		imgHeader = (ImageView) header.findViewById(R.id.img_head);
//
//		pullToRefreshText = getContext().getString(R.string.ptr_pull_to_refresh);  //下拉刷新
//		releaseToRefreshText = getContext().getString(R.string.ptr_release_to_refresh);//释放刷新
//		refreshingText = getContext().getString(R.string.ptr_refreshing);  //正在刷新
...
//			if( getFirstVisiblePosition() == 0 && event.getY() - previousY > 0 ) {//可以下拉刷新
//				enablePulling = true;
//				return true;
//			}else{
//				enablePulling = false; //不能下拉刷新
//			}
//			break;
...
//			}
//			
//			((AnimationDrawable)imgHeader.getBackground()).start();
//
//			break;
//
//		case RELEASE_TO_REFRESH:
